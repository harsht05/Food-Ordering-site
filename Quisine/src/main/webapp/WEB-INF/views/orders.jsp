			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link" href="users.html">Users <img
						...
						<li class="nav-item ml-auto mr-0"><a class="nav-link" href="logoutRequest">Logout</a></li>
...
<div class="container">
<h1 style="display: flex;justify-content: center;">All orders</h1>
            ...
            <tbody>
                <c:forEach items="${allorders}" var="order">
                    <tr>
                        ...
                        <td><formatDate value="${order.date}" pattern="yyyy-MM-dd"/>${order.date}</td>
                        <td>${order.restaurent.restName}</td> 
