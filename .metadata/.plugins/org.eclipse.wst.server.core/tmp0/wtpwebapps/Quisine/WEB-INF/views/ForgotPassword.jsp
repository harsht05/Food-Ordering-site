...
<body style="background-color:#ffc3a149;">
    ...
    <div class="container mb-2 position-absolute top-50 start-50 translate-middle p-3 mb-5 text-dark shadow-lg rounded">
        ...
        <div class="container m-2">
            ...
            <form class="row g-3" action="sendOtpForPassword" method="post">
        ...
        <p class="text-center text-dark end--3 p-2" style="float: left">Already Registered?&nbsp;&nbsp;<a href="loginPageRequest"
