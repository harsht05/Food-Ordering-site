		...
		<div class="row justify-content-center">
			<div class="col-md-6">
				<div class="alert alert-success text-center" role="alert">
					Congratulations! Your order has been placed.</div>

				<p class="mt-2 fw-bolder fs-2 text-center heading">Order Summary</p>
				...
				<div class="text-center mt-3">
					...
					<a href="feedbackload" class="btn btn-danger">Feedback
						</a>
				</div>
			</div>
		</div>
